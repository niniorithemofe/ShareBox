...
df = pd.read_csv("/Users/ninio/my_app/New folder/QAMLA/QAMLA-labels/Raw_Data/training_data.csv",on_bad_lines='skip')
...
data_folder = "QAMLA/QAMLA-labels/Dataa"
...
with open("QAMLA/QAMLA-labels/Dataa/labels.txt", "wb") as fp:
    pickle.dump(unique_labels, fp)

with open("QAMLA/QAMLA-labels/Dataa/id_to_label.txt", "wb") as fp:
...
with open("QAMLA/QAMLA-labels/Dataa/all_columns.txt", "wb") as fp:
    pickle.dump(list(df_new.columns), fp)

train, validation = train_test_split(df_new, test_size=0.1)

train.to_csv('/Users/ninio/my_app/New folder/QAMLA/QAMLA-labels/Dataa/train.csv', mode='w', index=False)
validation.to_csv('/Users/ninio/my_app/New folder/QAMLA/QAMLA-labels/Dataa/validation.csv', mode='w', index=False)