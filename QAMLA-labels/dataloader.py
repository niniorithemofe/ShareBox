...
def train_val_loader(path):
	...
	with open("QAMLA/QAMLA-labels/Dataa/all_columns.txt", "rb") as fp:
	...
	with open("QAMLA/QAMLA-labels/Dataa/text.pickle", "wb") as fp:
	...
	with open("QAMLA/QAMLA-labels/Dataa/labels.txt", "rb") as fp:
...
def test_loader(path):
	with open("QAMLA/QAMLA-labels/Dataa/text.pickle", "rb") as fp:
	...
	tst = TabularDataset(
		path='QAMLA/QAMLA-labels/Raw_Dataa/test.csv',
		format='csv',
		skip_header=True,
