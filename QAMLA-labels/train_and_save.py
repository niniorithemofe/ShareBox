...
def main(model, path):
	...
	print("="*30)
	print("\n")
	model = model.Rnn_Lstm(in_features, hidden_size, layer_num, 483)
...
if __name__=='__main__':
	...
	parser.add_argument("-f","--folder", help="Folder Containing train.csv and validation.csv", default="QAMLA/QAMLA-labels/Dataa/")
